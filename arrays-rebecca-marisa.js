...
var firstNames1 = ["John", "Mayuri", "Ashley"];
var firstNames2 = ["Charlean", "Rob", "Brandon"];

// console.log(firstNames1, firstNames2);
...
console.log(firstNames1.sort().reverse());
console.log(firstNames2.sort().reverse());
